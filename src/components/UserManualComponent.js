  ...
  return (
    <div style={styles.container}>
      ...
      <ul style={styles.list}>
        ...
        <li style={styles.listItem}>Supported formats: PNG and FITS, minimum resolution of the images: 1024 x 1024</li>
        <li style={styles.listItem}>The image should be a solar observation from either AIA or SUVI instruments. IMPORTANT: for the coronal holes segmentation, AIA 193 or SUVI 195 filters should be used, for active regions segmentation AIA 171 or SUVI 171.</li>
      </ul>

      <h4 style={styles.subtitle}>Sample Image Files</h4>
        <p style={styles.text}>
          You can download sample PNG and FITS images for testing the application from the following link:&nbsp;
            <a href="https://github.com/kkuichi/SCSS-Net-Client/tree/main/test_data" target="_blank" rel="noopener noreferrer">https://github.com/kkuichi/SCSS-Net-Client/tree/main/test_data
            </a>
        </p>
      ...
      <ul style={styles.list}>
        ...
        <li style={styles.listItem}>Choose the Threshold:
          ...
          <p style={styles.text}>
            In case, tha the image name in *.png format or FITS metadata contains time, instrument and date information, the application will automatically fill in the date and time fields. Otherwise, you can manually enter the date and time of the image acquisition.
          </p>
